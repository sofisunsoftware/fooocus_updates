...
def generate_clicked(*args):
    ...
    args = ['', '', ['Fooocus V2', 'Fooocus Enhance', 'Fooocus Sharp'], 'Speed', '1152×896 <span style="color: grey;"> ∣ 9:7</span>', 2, '3878226893166477156', 2, 4, 'juggernautXL_version6Rundiffusion.safetensors', 'None', 0.5, 'sd_xl_offset_example-lora_1.0.safetensors', 0.1, 'None', 1, 'None', 1, 'None', 1, 'None', 1, True, 'inpaint', 'Disabled', None, [], {'image': array([[[173, 136, 104],
        [175, 137, 106],
        [175, 138, 106],
       ...
       [[187, 157, 126],
        ...
        [199, 170, 144],
        [200, 171, 145],
        [198, 170, 144]]], dtype=uint8), 'mask': array([[[255, 255, 255],
        [255, 255, 255],
        [255, 255, 255],
       ...
       [[255, 255, 255],
        ...
        [255, 255, 255],
        [255, 255, 255],
        [255, 255, 255]]], dtype=uint8)}, 'change color to green', None, 0.5, 0.6, 'ImagePrompt', None, 0.5, 0.6, 'ImagePrompt', None, 0.5, 0.6, 'ImagePrompt', None, 0.5, 0.6, 'ImagePrompt']
